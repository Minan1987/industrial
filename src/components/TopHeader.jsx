    ...
    <section className="header">
      ...
      <div className="container">
        <div className="row justify-content-between align-items-center">
          <div className='col-6'><p>Welcome to Leader in Industrial Solution since 2005</p></div>
          <div className='col-6'><p className='text-end'>Global Certificate: <span>ISO 9001:2015 </span></p></div>
        </div>
      </div>
      </div>
      <div className="container-fluid-sm container-md">
        <div className="row justify-content-between align-items-center py-4">
          <div className="logo col-md-4 col-lg-6 d-none d-md-block">
            <Link to="/">
              <img src={logo} alt="Industrial Logo" width="200px" />
            </Link>
          </div>
          <div className="contact-info col-12 col-md-8 col-lg-6 ">
            <div className="d-flex justify-content-around justify-content-lg-end align-items-center">
              ...
              <div className='ms-4'>
                <button className='btn btn-warning'>REQUEST A QUOTE</button>
              </div>
            </div>
          </div>
        </div>
