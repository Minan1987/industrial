      ...
      <div className="container">
        <div className="row py-5">
          <div className="col-lg-3 col-md-6 col-sm-12">
            <Link to="/" ><img src={logo} alt="Industrial Logo" className='mb-4' width="170px" /></Link>
            <p style={{ color: "#7f92a7" }}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            <Link to="/" className='text-info text-decoration-none'>Read More <MdKeyboardDoubleArrowRight /></Link>
          ...
          <div className="col-lg-3 col-md-6 col-sm-12 footer-links">
            <h3 className='text-light fs-5 mb-5'>Our Solutions<hr /></h3>
            <ul className='list-unstyled'>
              <li><Link to="/">-Power And Energy</Link></li>
              <li><Link to="/">-Oil And Lubricant</Link></li>
              <li><Link to="/">-Material Engineering</Link></li>
              <li><Link to="/">-Mechanical Engineering</Link></li>
              <li><Link to="/">-chemical Research</Link></li>
              <li><Link to="/">-Alternate Energy</Link></li>
            </ul>
          </div>
          <div className="col-lg-3 col-md-6 col-sm-12 footer-links quick">
            <h3 className='text-light fs-5 mb-5'>Quick Links<hr /></h3>
            <ul className='list-unstyled'>
          ...
          <div className="col-lg-3 col-md-6 col-sm-12 footer-links contact-links">
            <h3 className='text-light fs-5 mb-5'>Get In Touch<hr /></h3>
            <ul className='list-unstyled'>
      ...
      <div className="copy-right py-4">
        <div className="container">
          <div className="row justify-content-between align-items-center">
            <div className="col-12 col-md-6 text-center text-md-start">Copyright © 2024 Industrial wp demo. All rights reserved.</div>
            <div className="col-12 col-md-6 text-center text-md-end">Developed by Mina Nazari</div>
          </div>
        </div>
